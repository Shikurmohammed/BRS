...
public interface BookMapper {
    ...
    @Insert("INSERT INTO Book (Title,Author,ISBN,PublicationDate,Genere,Type,RegistrationDate,NumberOfCopies,Edition) VALUES(#{title},#{author},#{iSBN},#{publicationDate},#{genre},#{type},#{registrationDate},#{numberOfCopies},#{edition})")
